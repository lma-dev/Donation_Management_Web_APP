...
import { purgeSupporterDonation } from "@/features/monthly-overview/domain";
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    await logAction({
      ...
      actionLabel: "Supporter Donation Permanently Deleted",
      details: `Permanently deleted supporter donation: ${id}`,
    });
    ...
    return NextResponse.json(
      { error: "Failed to permanently delete supporter donation" },
      { status: 500 },
    );
  }
}
