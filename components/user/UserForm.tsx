...
import type { User, CreateUserFormData, UpdateUserFormData, UserRole } from "@/types/user";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const data = isEditing
        ? { name, email, password, confirmPassword, role } as UpdateUserFormData
        : { name, email, role } as CreateUserFormData;
      await onSubmit(data);
    } catch (err) {
