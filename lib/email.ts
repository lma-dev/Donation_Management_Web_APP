...
export async function sendWelcomeEmail(
  ...
  const html = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <p style="color: #444; line-height: 1.6;">Your account has been created. Please set your password by clicking the button below:</p>
      ...
      <p style="color: #444; line-height: 1.6; margin-top: 24px;">This link will expire in 1 hour. If you did not expect this email, you can safely ignore it.</p>
  ...
  try {
    await transporter.sendMail({
      from,
      to,
      subject: "Welcome to Spring Liberation Rose — Set Your Password",
      html,
    });
    return true;
  } catch (error) {
